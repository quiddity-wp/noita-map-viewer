...
var gourd_cave_404 = L.marker([-0.19675, 0.35046], {icon: pin_blue}).addTo(map);
...
var shop_sky_01 = L.marker([-0.14563, 0.2244], {icon: pin_blue}).addTo(map);
var shop_sky_02 = L.marker([-0.08633, 0.17417], {icon: pin_blue}).addTo(map);
