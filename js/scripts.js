...
var achievement_pillars = L.marker([-59.727, 47.33], {icon: pin_blue}).addTo(map);
var anvil = L.marker([-74.305, 53.516], {icon: pin_blue}).addTo(map);
var avarice_diamond = L.marker([-70.9, 69], {icon: pin_blue}).addTo(map);
var bammalam_monument = L.marker([-61.15, 46.78], {icon: pin_blue}).addTo(map);
var big_fungus = L.marker([-68.85, 62], {icon: flag_violet}).addTo(map);
var blood_portal = L.marker([-63.07, 23.035], {icon: pin_blue}).addTo(map);
var buried_eye_portal = L.marker([-71.012, 58.041], {icon: pin_blue}).addTo(map);
var cabin = L.marker([-62.827, 26.201], {icon: pin_blue}).addTo(map);
var cabin_secret_01 = L.marker([-63.261, 26.182], {icon: pin_blue}).addTo(map);
var cabin_secret_02 = L.marker([-63.691, 25.496], {icon: pin_blue}).addTo(map);
var cauldron_room = L.marker([-73.205, 57.943], {icon: help}).addTo(map);
var coral_chest = L.marker([-52.939, 72.998], {icon: pin_blue}).addTo(map);
var curse_of_greed = L.marker([-61.613, 47.813], {icon: pin_blue}).addTo(map);
var dark_cave = L.marker([-63.641, 46.922], {icon: heart}).addTo(map);
var dark_chest = L.marker([-92.932, 57.998], {icon: pin_blue}).addTo(map);
var dark_moon = L.marker([-136.187, 51], {icon: pin_blue}).addTo(map);
var dragon = L.marker([-77.084, 55.072], {icon: error}).addTo(map);
var end_of_everything_room = L.marker([-92.094, 40.963], {icon: pin_blue}).addTo(map);
var esa_carving = L.marker([-60.771, 47.348], {icon: pin_blue}).addTo(map);
var essence_eater_east = L.marker([-62.479, 75.049], {icon: pin_blue}).addTo(map);
var essence_eater_west = L.marker([-62.119, 37.055], {icon: pin_blue}).addTo(map);
var essence_of_air = L.marker([-51.952, 25.002], {icon: pin_blue}).addTo(map);
var essence_of_earth = L.marker([-58.954, 82], {icon: pin_blue}).addTo(map);
var essence_of_fire = L.marker([-63.17, 23.035], {icon: pin_blue}).addTo(map);
var essence_of_spirits = L.marker([-88.955, 23], {icon: pin_blue}).addTo(map);
var essence_of_water = L.marker([-94.953, 40], {icon: pin_blue}).addTo(map);
var evil_eye = L.marker([-62.055, 45.746], {icon: pin_blue}).addTo(map);
var experimental_wand = L.marker([-81.95, 81.986], {icon: pin_blue}).addTo(map);
var eye_room = L.marker([-73, 43.002], {icon: pin_blue}).addTo(map);
var friend_cavern_01 = L.marker([-71, 30], {icon: flag_green}).addTo(map);
var friend_cavern_02 = L.marker([-72, 41], {icon: flag_green}).addTo(map);
var friend_cavern_03 = L.marker([-74, 57], {icon: flag_green}).addTo(map);
var friend_cavern_04 = L.marker([-88, 41], {icon: flag_green}).addTo(map);
var friend_cavern_05 = L.marker([-85, 29], {icon: flag_green}).addTo(map);
var friend_cavern_06 = L.marker([-82, 59], {icon: flag_green}).addTo(map)
var fungal_altar_01 = L.marker([-53.045, 62.1], {icon: flag_violet}).addTo(map);
var fungal_altar_02 = L.marker([-66.039, 80.015], {icon: flag_violet}).addTo(map);
var fungal_altar_03 = L.marker([-82.045, 76.018], {icon: flag_violet}).addTo(map);
var fungal_altar_04 = L.marker([-66.043, 44.014], {icon: flag_violet}).addTo(map);
var fungal_altar_05 = L.marker([-82.042, 48.037], {icon: flag_violet}).addTo(map);
var fungus_quest = L.marker([-62.460, 62.08], {icon: flag_violet}).addTo(map);
var gate_guardian = L.marker([-85.139, 56.02], {icon: error}).addTo(map);
var gold_biome_01 = L.marker([-55.996, 79.967], {icon: pin_blue}).addTo(map);
var gold_biome_02 = L.marker([-94.949, 23.027], {icon: pin_blue}).addTo(map);
var gold_biome_03 = L.marker([-55.992, 9.973], {icon: pin_blue}).addTo(map);
var gourd_cave = L.marker([-50.166, 18.891], {icon: heart}).addTo(map);
var gourd_cave_404 = L.marker([-49.953, 89.012], {icon: pin_blue}).addTo(map);
var grand_master = L.marker([-92.203, 75], {icon: error}).addTo(map);
var high_alchemist = L.marker([-64.217, 40.996], {icon: error}).addTo(map);
var hourglass_room = L.marker([-72.686, 53.834], {icon: pin_blue}).addTo(map);
var kantele = L.marker([-60.975, 47.25], {icon: pin_blue}).addTo(map);
var karl_the_mighty = L.marker([-66.934, 56.863], {icon: face_happy}).addTo(map);
var kolmi = L.marker([-87.914, 57.43], {icon: error}).addTo(map);
var leviathan = L.marker([-82.088, 23.15], {icon: error}).addTo(map);
var mecha_kolmi = L.marker([-84.098, 78], {icon: error}).addTo(map);
var meditation_cube_room = L.marker([-66.996, 42.014], {icon: pin_blue}).addTo(map);
var moon = L.marker([-12.022, 50.996], {icon: pin_blue}).addTo(map);
var moon_radar_perk = L.marker([-68.952, 81.984], {icon: pin_blue}).addTo(map);
var mountain_altar = L.marker([-60.195, 52.025], {icon: pin_blue}).addTo(map);
var music_box_desert = L.marker([-62.418, 79.195], {icon: pin_blue}).addTo(map);
var music_box_giant_tree = L.marker([-59.834, 46.77], {icon: pin_blue}).addTo(map);
var music_box_lake = L.marker([-61.648, 26.7], {icon: pin_blue}).addTo(map);
var music_box_pond = L.marker([-62.904, 55.971], {icon: pin_blue}).addTo(map);
var music_stone = L.marker([-68.9, 44], {icon: pin_blue}).addTo(map);
var ocarina = L.marker([-49.805, 31], {icon: pin_blue}).addTo(map);
var orb_cement = L.marker([-94.221, 71], {icon: circle_blue}).addTo(map);
var orb_deercoy = L.marker([-91.232, 33], {icon: circle_blue}).addTo(map);
var orb_earthquake = L.marker([-60.199, 69.996], {icon: circle_blue}).addTo(map);
var orb_fireworks = L.marker([-94.215, 50], {icon: circle_blue}).addTo(map);
var orb_holy_bomb = L.marker([-70.23, 42], {icon: circle_blue}).addTo(map);
var orb_necromancy = L.marker([-68.215, 70], {icon: circle_blue}).addTo(map);
var orb_nuke = L.marker([-66.207, 57.285], {icon: circle_blue}).addTo(map);
var orb_sea_of_lava = L.marker([-60.39, 52.023], {icon: circle_blue}).addTo(map);
var orb_spiral_shot = L.marker([-82.232, 43], {icon: circle_blue}).addTo(map);
var orb_tentacle = L.marker([-68.229, 31], {icon: circle_blue}).addTo(map);
var orb_thundercloud = L.marker([-64.229, 59], {icon: circle_blue}).addTo(map);
var perk_removal_altar = L.marker([-77.211, 78], {icon: pin_blue}).addTo(map);
var portal_to_coral_chest = L.marker([-76.758, 58.221], {icon: pin2_red}).addTo(map);
var portal_to_hell_orb_room = L.marker([-77.256, 58.207], {icon: pin2_red}).addTo(map);
var portal_to_island = L.marker([-77, 57.742], {icon: pin2_red}).addTo(map);
var portal_to_nullifying_altar = L.marker([-77.043, 58.236], {icon: pin2_red}).addTo(map);
var portal_to_ocarina = L.marker([-76.752, 57.75], {icon: pin2_red}).addTo(map);
var portal_to_snowy_chasm_orb_room = L.marker([-77.244, 57.764], {icon: pin2_red}).addTo(map);
var power_plant_biome = L.marker([-95.914, 17.967], {icon: pin_blue}).addTo(map);
var power_plant_infinite = L.marker([-97.047, 18], {icon: pin_blue}).addTo(map);
var rainbow_trail_spell = L.marker([-56.951, 23.152], {icon: pin_blue}).addTo(map);
var reward_diamond = L.marker([-70.895, 70], {icon: pin_blue}).addTo(map);
var scales = L.marker([-62.361, 76.008], {icon: pin_blue}).addTo(map);
var secret_platforms = L.marker([-61.822, 26.703], {icon: pin_blue}).addTo(map);
var shop_hell_01 = L.marker([-117.895, 44.248], {icon: pin_blue}).addTo(map);
var shop_hell_02 = L.marker([-132.967, 57], {icon: pin_blue}).addTo(map);
var shop_sky_01 = L.marker([-36.99, 56.998], {icon: pin_blue}).addTo(map);
var shop_sky_02 = L.marker([-21.91, 44.254], {icon: pin_blue}).addTo(map);
var skull_portal = L.marker([-62.537, 64.992], {icon: pin_blue}).addTo(map);
var teleport_room = L.marker([-76.746, 57.984], {icon: pin_blue}).addTo(map);
var the_forgotten = L.marker([-88.225, 28], {icon: error}).addTo(map);
var the_work = L.marker([-92.041, 62.996], {icon: pin_blue}).addTo(map);
var three_eyes_legs = L.marker([-60.85, 69.988], {icon: error}).addTo(map);
var tiny = L.marker([-98.75, 79.553], {icon: error}).addTo(map);
var tower_entrance = L.marker([-80.387, 69.524], {icon: pin_blue}).addTo(map);
var tower_portal = L.marker([-83.826, 42], {icon: pin_blue}).addTo(map);
var warning_01 = L.marker([-60.5, 92.75], {icon: error}).addTo(map);
var warning_02 = L.marker([-60.5, 9.6], {icon: error}).addTo(map);
var wormy_egg = L.marker([-61.523, 48.459], {icon: pin_blue}).addTo(map);
var you = L.marker([-62.282, 50.945], {icon: pin_blue}).addTo(map);
...
gourd_cave_404.bindPopup("<b>Gourd Cave</b><hr>This is where it would normally be, but it does not exist in parallel worlds.");
...
shop_hell_01.bindPopup("<b>Shop (Hell)</b>");
shop_hell_02.bindPopup("<b>Shop (Hell)</b>");
shop_sky_01.bindPopup("<b>Shop (Sky)</b>");
shop_sky_02.bindPopup("<b>Shop (Sky)</b>");
